...
class ReaderMenu extends StatefulWidget {
  ...
  ReaderMenu(
      {this.chapters, this.articleIndex, this.onTap, this.onPreviousArticle, this.onNextArticle, this.onToggleChapter});
...
class _ReaderMenuState extends State<ReaderMenu> with SingleTickerProviderStateMixin {
  ...
  buildTopView(BuildContext context) {
    return Positioned(
      ...
      right: 0,
      child: Container(
        decoration: BoxDecoration(color: Colours.paper, boxShadow: TextStyles.borderShadow),
